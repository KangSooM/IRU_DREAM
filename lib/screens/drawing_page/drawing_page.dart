...
class _DrawingPageState extends State<DrawingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Consumer<ChangePages>(
          builder: (_, __, ___) => ChangeNotifierProvider.value(
            value: c.array[c.pages],
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage(
                                'assets/pages/iru${c.pages + 1}.png',
                              ),
                              fit: BoxFit.cover)),
                      ...
                      child: Stack(
                        children: [
                          Positioned.fill(
                            child: Consumer<DrawingProvider>(
                              builder: (_, __, ___) => CustomPaint(
                                  painter:
                                      DrawingPainter(c.array[c.pages].lines)
                                  // p.brushMode
                          ...
                          GestureDetector(
                            ...
                            onPanStart: (s) {
                              if (c.array[c.pages].eraseMode) {
                                c.array[c.pages].erase(s.localPosition);
                              } else {
                                c.array[c.pages].drawStart(s.localPosition);
                              }
                            },
                            onPanUpdate: (s) {
                              if (c.array[c.pages].eraseMode) {
                                ...
                                c.array[c.pages].brushDrawing(s.localPosition);
                              }
                            },
                            child: Container(),
                          ),
  ...
  Widget _previousPage(int page, BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        c.pages > 0 ? null : c.changePages = 0;
      },
  ...
  Widget _followingPage(int page, BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        c.changePages = page + 1;
        c.pages < 5 ? null : c.changePages = 4;
      },
